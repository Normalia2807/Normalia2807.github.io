...
$routes->group('user',['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('peminjaman', 'Peminjaman::index', ['as' => 'user.peminjaman']);
    $routes->get('pengembalian', 'Pengembalian::index', ['as' => 'user.pengembalian']);
    $routes->get('logout', 'Logout::index', ['as' => 'user.logout']);
    ...
    $routes->get('/peminjaman/store', 'Peminjaman::store');
    $routes->get('/pengembalian', 'Pengembalian::index');
    $routes->get('/pengembalian/create', 'Pengembalian::create');
    $routes->get('/pengembalian/store', 'Pengembalian::store');
