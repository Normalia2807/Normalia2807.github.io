        ...
        <form class="" method="post" action="<?= base_url('buku/store') ?>" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label for="nim" class="col-sm-2 col-form-label">Kode_Buku</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="nim" name="nim" placeholder="id buku" value="<?= old('kode buku'); ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="nama" class="col-sm-2 col-form-label">id_buku</label>
                    <div class="col-sm-6">
