    ...
    <div class="card card-primary">
        ...
        <form class="form-horizontal" method="post" action="<?= base_url('mahasiswa/update/' . $mahasiswa->nim) ?>" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="jurusan" class="form-control" id="jurusan">
                            ...
                            <option value="Teknik Informatika" <?= ($mahasiswa->jurusan == "pria" ? "selected" : ""); ?>>Teknik Informatika</option>
                            <option value="Sistem Informasi" <?= ($mahasiswa->jurusan == "wanita" ? "selected" : ""); ?>>Sistem Informasi</option>
                            <option value="Manajemen Informatika" <?= ($mahasiswa->jurusan == "wanita" ? "selected" : ""); ?>>Manajemen Informatika</option>
                        </select>
                    </div>
                </div>
                ...
                <input type="file" class="custom-file-input" id="foto" name="foto"><label class="custom-file-label" for="foto"><?= $mahasiswa->foto;?></label>
                </div>
